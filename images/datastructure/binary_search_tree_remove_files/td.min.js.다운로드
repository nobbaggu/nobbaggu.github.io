...
var __Tiara=__Tiara||{};__Tiara.version='2.8.6';__Tiara.enumerables=['hasOwnProperty','valueOf','isPrototypeOf','propertyIsEnumerable','toLocaleString','toString','constructor'];__Tiara.isArray=Array.isArray||function(arr){return Object.prototype.toString.call(arr)==='[object Array]';};__Tiara.apply=function(o,c,defaults){'use strict';var p;if(defaults){__Tiara.apply(o,defaults);}
...
return Array.prototype.push.apply(this,passArguments);};return{__click:function(e){var evt=e||window.event,node=evt.srcElement||evt.target,info={};if(isIgnoreClickButtonClick(evt)){return true;}
