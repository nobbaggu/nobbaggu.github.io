...
<img class="aligncenter size-full wp-image-268" src="/images/2018/08/1-1.png" alt="" width="900" height="478" srcset="/images/2018/08/1-1.png 900w, /images/2018/08/1-1-300x159.png 300w, /images/2018/08/1-1-768x408.png 768w" sizes="(max-width: 900px) 100vw, 900px" /> 
...
<img class="aligncenter size-full wp-image-269" src="/images/2018/08/2.png" alt="" width="900" height="479" srcset="/images/2018/08/2.png 900w, /images/2018/08/2-300x160.png 300w, /images/2018/08/2-768x409.png 768w" sizes="(max-width: 900px) 100vw, 900px" /> 
...
<img class="aligncenter size-full wp-image-271" src="/images/2018/08/s.png" alt="" width="900" height="390" srcset="/images/2018/08/s.png 900w, /images/2018/08/s-300x130.png 300w, /images/2018/08/s-768x333.png 768w" sizes="(max-width: 900px) 100vw, 900px" /> 
...
<img class="aligncenter size-full wp-image-272" src="/images/2018/08/3-2.png" alt="" width="900" height="318" srcset="/images/2018/08/3-2.png 900w, /images/2018/08/3-2-300x106.png 300w, /images/2018/08/3-2-768x271.png 768w" sizes="(max-width: 900px) 100vw, 900px" /> 

위의 두 함수를 불러서 실행해보자.

<img class="aligncenter size-full wp-image-273" src="/images/2018/08/4.png" alt="" width="900" height="452" srcset="/images/2018/08/4.png 900w, /images/2018/08/4-300x151.png 300w, /images/2018/08/4-768x386.png 768w" sizes="(max-width: 900px) 100vw, 900px" /> 
...
<img class="aligncenter size-full wp-image-274" src="/images/2018/08/5.png" alt="" width="900" height="464" srcset="/images/2018/08/5.png 900w, /images/2018/08/5-300x155.png 300w, /images/2018/08/5-768x396.png 768w" sizes="(max-width: 900px) 100vw, 900px" /> 
...
<img class="aligncenter size-full wp-image-275" src="/images/2018/08/6.png" alt="" width="900" height="464" srcset="/images/2018/08/6.png 900w, /images/2018/08/6-300x155.png 300w, /images/2018/08/6-768x396.png 768w" sizes="(max-width: 900px) 100vw, 900px" /> 

아까보단 scale이 10^1만큼이나 cost function이 작아졌지만 아직도 차이가 많이 나는 것 같다. sample data들을 더 쳐내보자. 아예 뇌의 무게가 20 이하인 것들만 남겨둬보겠다.

<img class="aligncenter size-full wp-image-276" src="/images/2018/08/7.png" alt="" width="900" height="466" srcset="/images/2018/08/7.png 900w, /images/2018/08/7-300x155.png 300w, /images/2018/08/7-768x398.png 768w" sizes="(max-width: 900px) 100vw, 900px" /> 
