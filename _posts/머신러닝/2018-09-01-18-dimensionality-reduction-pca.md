...
![image](https://nobbaggu.github.io/images/2018/08/no-name-108.png){: width="50%" height="50%"}
...
![image](https://latex.codecogs.com/gif.latex?&space;\Sigma){: width="50%" height="50%"}

&nbsp;

![image](https://latex.codecogs.com/gif.latex?:n&space;\times&space;m){: width="50%" height="50%"}

이다. 따라서 covariant matrix는 ![image](https://latex.codecogs.com/gif.latex?&space;n&space;\times&space;n){: width="50%" height="50%"}

&nbsp;

<span style="font-size: 14pt;"><strong>b)  covariant matrix </strong></span><span style="font-size: 14pt;"><strong>![image](https://latex.codecogs.com/gif.latex?&space;U){: width="50%" height="50%"}

covariant matrix의 eigen vector들로 이루어진 matrix  ![image](https://latex.codecogs.com/gif.latex?&space;X){: width="50%" height="50%"}

&nbsp;

<span style="font-size: 14pt;"><strong>c) k dimensional vector z들의 matrix ![image](https://latex.codecogs.com/gif.latex?&space;Z){: width="50%" height="50%"}

먼저 U의 1~k번째 column만으로 이루어진 matrix  ![image](https://latex.codecogs.com/gif.latex?&space;n&space;\times&space;k){: width="50%" height="50%"}

![image](https://latex.codecogs.com/gif.latex?&space;m&space;\times&space;k){: width="50%" height="50%"}

결국 우리는![image](https://latex.codecogs.com/gif.latex?&space;Z){: width="50%" height="50%"}

![image](https://latex.codecogs.com/gif.latex?){: width="50%" height="50%"}

Z의 각 data example은 k개의 feature를 가지고 있다. 각각의 ![image](https://latex.codecogs.com/gif.latex?){: width="50%" height="50%"}
...
<span style="font-size: 18pt;"><strong>2. Reconstruction ![image](https://latex.codecogs.com/gif.latex?&space;Z){: width="50%" height="50%"}

* * *

![image](https://latex.codecogs.com/gif.latex?){: width="50%" height="50%"}

반대로![image](https://latex.codecogs.com/gif.latex?){: width="50%" height="50%"}
...
PCA 알고리즘을 사용하면 n개의 feature를 k개의 feature로 줄일 수 있다 하였다. 이 때 k를 몇으로 정하는 것이 좋을지 생각해보지 않을 수 없다.
  ...
  *![image](https://latex.codecogs.com/gif.latex?\leq&space;0.01){: width="50%" height="50%"}
...
<table style="width: 100%; border-collapse: collapse; border-style: double; background-color: #ebe8e8;" border="1">
  <tr>
    <td style="width: 100%;">
      ...
      <p>
        2) $$U_{reduce},z^{(i)},x_{approx}^{(i)}$$를 계산한다.
      </p>
      ...
      <p>
        ...
        <p>
          ![image](https://latex.codecogs.com/gif.latex?\geq&space;0.99){: width="50%" height="50%"}
        </p>
